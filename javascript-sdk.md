...
**_On click of \[Pay for your order with RocketFuel\] paste below Code Snippet._**
...
1.  Create merchant Auth using the [PUBLIC\_KEY](https://bitbucket.org/rocketfuelblockchain/rocketfuel-readme/src/master/notification.md)
    *   JS Code snippet
...
rkflToken can be used in the following 2 ways:-
===============================================

*   Autosignup for new customer
*   Direct invocation for existing customer
